...
const StudentsView = {
  ...
  async saveNewStudent() {
    ...
    try {
      const addedStu = await studentService.addStudent(studentData);
      UIService.closeModal();
      
      if (addedStu.tempPassword) {
        const pwdHtml = `
